...
export default function Home() {
  ...
  return (
    <div className="home">
      ...
      <section className="cta-section">
        <div className="cta-wrapper">
          ...
          <div className="cta-actions">
            ...
            <a href="tel:0508535941" className="btn-secondary large">050-8535941</a>
          </div>
        </div>
      </section>
      ...
      <a href="https://wa.me/972508535941" target="_blank" rel="noopener noreferrer" className="floating-contact">
