...
const RESPONSES = {
  ...
  experience: 'סופיה מביאה ניסיון עשיר של למעלה מעשור בתחום הקוסמטיקה הקלינית. 🏆\n\nהיא מחזיקה בתעודות מקצועיות מובילות ומטפלת במאות לקוחות מרוצים.\n\nתוכלו לראות עבודות לדוגמה בעמוד "עבודות לפני ואחרי".',
  
  products: 'ניתן לצפות ברשימה המלאה של המוצרים והשירותים שלנו בעמוד "מוצרים".\n\nיש לנו מגוון רחב של:\n• מוצרי טיפוח איכותיים\n• ציוד מקצועי\n• חבילות טיפולים\n\nלפרטים נוספים: 050-8535941',
